...
T7|.|the corpus needs items whose fix IS a named shape. today's 3 were mined from 34 + 24 + 1 applications in OUR tree ∴ the 4th variable is measurable only once a 2nd & 3rd stranger have contributed theirs|V8,`src/review:T6`
