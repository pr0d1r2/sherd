...
T103|~|LADDER rungs as work: 0.4 = `split`+`sync` · 0.5 = the MECHANICAL surface correct & reusable, measured on a foreign repo · 0.6 = settle · 0.7 = the model half resumes (V117). 0.1-0.3 reached|V114,V117
